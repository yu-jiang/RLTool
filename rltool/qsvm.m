classdef qsvm < handle
    ...
    methods
        ...
        function this = qsvm(statedim, actionSamples)
            % Create network
            this.Qnn = fitrsvm(zeros(1,statedim+1), 0);
